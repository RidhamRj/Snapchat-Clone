    ...
    return (
        ...
        <NavContainer id='nav' className='navContainer' onMouseMove={drop}>
            ...
            <navItems className="navItems">
                ...
                <span id="features" className='features link link-underline link-underline-black'>Features  </span><i id='down' className='icon-down'><img width="10px" src="https://www.svgrepo.com/show/80156/down-arrow.svg" alt="" srcset="" /></i> <i id='up' className='act'><img width="10px" src="https://www.svgrepo.com/show/93813/up-arrow.svg" alt="" /></i>
            {/* </navItems> */}
